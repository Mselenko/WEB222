...
window.onload=function(){
    ...
    document.querySelector("#video").innerHTML = "<video class='right' width=" + video.width+ " height=" +video.height + " controls=" + video.controls + " ><source src=" + video.source[i].src + " type=" + video.source[i].type + ">Your browser does not support the video tag.</video>";
    }
}